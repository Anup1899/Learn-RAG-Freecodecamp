...
# 1. Structured Logging - Human readable story
# 2. Metrics Collection - Number of Dashboard
# 3. Instrumented LLM - Around every LLM call


# Monitoring is the outermost layer - it observes everything but does not change the behavior of the system.
...
if __name__ == "__main__":
    ...
    # logger.info("Structured logging setup complete." , extra={"extra": {"app": "langgraph"}})
    demo_monitoring()
