...
# langchain_postgres uses SQLAlchemy, which defaults to the psycopg2 driver for
# a plain "postgresql://" URL. Only psycopg (v3) is installed here, so force
# SQLAlchemy to use that driver instead.
